...
export const DICT = {
  en: {
    ...
    // account (solo vs online sync)
    syncAcross: "Sync across devices", syncOn: "Create an account so your profile, friends, and history follow you to other devices.",
    syncOff: "This device only", syncOffDesc: "Nothing leaves this device — fastest way to get playing.",
    account: "account", guestAccount: "Guest account", guestAccountDesc: "Add an email so you can sign in from another device.",
    signedInAs: (e) => `Signed in as ${e}`, emailPlaceholder: "you@email.com",
    sendLink: "Send magic link", linkSent: "Check your inbox for the link.", linkError: "Couldn't send that link — try again.",
    haveAccount: "Already have an account on this device?", signInEmail: "Sign in with email",
    signOut: "Sign out", soloDataNote: "Local data — not synced.",
    // pay sheet
  ...
  ru: {
    ...
    syncAcross: "Синхронизировать между устройствами", syncOn: "Создайте аккаунт, чтобы профиль, друзья и история были доступны на других устройствах.",
    syncOff: "Только это устройство", syncOffDesc: "Ничего не покидает это устройство — самый быстрый способ начать играть.",
    account: "аккаунт", guestAccount: "Гостевой аккаунт", guestAccountDesc: "Добавьте email, чтобы входить с другого устройства.",
    signedInAs: (e) => `Вход выполнен как ${e}`, emailPlaceholder: "you@email.com",
    sendLink: "Отправить ссылку", linkSent: "Проверьте почту — там ссылка для входа.", linkError: "Не удалось отправить ссылку — попробуйте ещё раз.",
    haveAccount: "Уже есть аккаунт на этом устройстве?", signInEmail: "Войти по email",
    signOut: "Выйти", soloDataNote: "Локальные данные — без синхронизации.",
