...
export const THEME = {
  ink: "#17120E", felt: "#241C15", sheet: "#241C15", room: "#241C15", raise: "#2E241A", line: "#3C2F21",
...
export const C = {
  ink: "var(--ink)", felt: "var(--felt)", sheet: "var(--sheet)", room: "var(--room)", raise: "var(--raise)",
...
export const themeVars = (t) => ({
  "--ink": t.ink, "--felt": t.felt, "--sheet": t.sheet, "--room": t.room, "--raise": t.raise, "--line": t.line,
